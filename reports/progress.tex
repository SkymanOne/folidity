...
\begin{abstract}
  ...
  attempt to address these issues. However, neither of the approaches have managed to combine
  ...
  with a unique approach to reasoning about modelling and development of Smart Contract systems.
...
As mentioned above, Solidity's imperative style compromises a safe development process. Therefore,
